...
designer_questions = [
	...
	['Section II', 'Calculations', 'Managing Principal Comments', 'text', [2, 3, 4]],
	['Section II', 'Calculations', 'Employee Comments', 'text', [2, 3, 4]],
	...
	['Section II', 'System (Choice of)', 'Managing Principal Comments', 'text', [3, 4]],
	['Section II', 'System (Choice of)', 'Employee Comments', 'text', [3, 4]],
	...
	['Section III', 'Field Review', 'Managing Principal Comments', 'text', [3, 4]],
	['Section III', 'Field Review', 'Employee Comments', 'text', [3, 4]],
	...
	['Section III', 'RFIs', 'Managing Principal Comments', 'text', [1, 2, 3, 4]],
	['Section III', 'RFIs', 'Employee Comments', 'text', [1, 2, 3, 4]],
	['Section III', 'Contract Administration', 'Able to determine if shop drawings meet specifications ', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Able to determine if maintenance manual meet specifications', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Responds in a timely manner', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Documents in accordance with CEL standards', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Provides clear/concise response in shop drawings and identifies what is required', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Able to track according to CEL standards', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Able to create clear and concise CCNs, Site Instructions and Addendas', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Issue in a timely manner', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Reviews costing and determines appropriateness and quantity', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Able to determine if construction is in accordance to documents', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Creates clear and concise site visit reports', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Issues SVR and deficiency lists in a timely manner', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Effectively evaluates project completeness for progress', 'check_box', [3, 4]],
	['Section III', 'Contract Administration', 'Managing Principal Comments', 'text', [3, 4]],
	['Section III', 'Contract Administration', 'Employee Comments', 'text', [3, 4]],
	['Section IV', 'Client Interface', 'Communicates with client in a timely manner', 'check_box', [2, 3, 4]],
	['Section IV', 'Client Interface', 'Able to communicate effectively both oral and written', 'check_box', [2, 3, 4]],
	['Section IV', 'Client Interface', 'Promotes CEL in a professional manner at all times', 'check_box', [2, 3, 4]],
	['Section IV', 'Client Interface', 'Managing Principal Comments', 'text', [2, 3, 4]],
	['Section IV', 'Client Interface', 'Employee Comments', 'text', [2, 3, 4]],
	['Section IV', 'Organizational', 'Arrives at meetings on time', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Arrives and leaves in accordance with their working schedule', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Attends internal meetings', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Participates in training', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Maintains an organized desk', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Files emails and design files on network', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Follows company project closeout procedures', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Timesheets are completed on time', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Expenses are submitted on time', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Complies with CEL policies and procedures', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Ability to work independently with minimal input from supervisor', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Participates in learning sessions', 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Managing Principal Comments', 'text', [1, 2, 3, 4]],
	['Section IV', 'Organizational', 'Employee Comments', 'text', [1, 2, 3, 4]],
	['Section IV', 'Health and Safety', "Complies with CEL's H&S program", 'check_box', [1, 2, 3, 4]],
	['Section IV', 'Health and Safety', 'Managing Principal Comments', 'text', [1, 2, 3, 4]],
	['Section IV', 'Health and Safety', 'Employee Comments', 'text', [1, 2, 3, 4]],
	['Section V', 'Feedback on Overall Performance Results: How Results Were Achieved', 'Strengths', 'text', [1, 2, 3, 4]],
	['Section V', 'Feedback on Overall Performance Results: How Results Were Achieved', 'Improvement Areas', 'text', [1, 2, 3, 4]],
	['Section V', 'Performance Goals for the Upcoming Year', 'Goals', 'text', [1, 2, 3, 4]],
	['Section V', 'Performance Goals for the Upcoming Year', 'Timeframe for completion', 'text', [1, 2, 3, 4]],
	['Section V', 'Choose 1-2 development goals to focus on this year to enhance ', 'Goals', 'text', [1, 2, 3, 4]],
	['Section V', 'Choose 1-2 development goals to focus on this year to enhance ', 'Timeframe for completion', 'text', [1, 2, 3, 4]],
	['Section V', 'Identify 1-2 career development goals to help make progress for longer-tem ', 'Goals', 'text', [1, 2, 3, 4]],
...
questions = [
	...
	['Section I', 'Drawing', 'Managing Principal Comments:', 'text', [1, 2, 3]],
	['Section I', 'Drawing', 'Employee Comments:', 'text', [1, 2, 3]],
	...
	['Section I', 'Production', 'Managing Principal Comments:', 'text', [1, 2, 3]],
	['Section I', 'Production', 'Employee Comments:', 'text', [1, 2, 3]],
	...
	['Section I', 'Layout', 'Managing Principal Comments:', 'text', [1, 2, 3, 4, 5, 6]],
	['Section I', 'Layout', 'Employee Comments:', 'text', [1, 2, 3, 4, 5, 6]],
	...
	['Section II', 'Calculations', 'Managing Principal Comments:', 'text', [2, 3, 4, 5, 6]],
	['Section II', 'Calculations', 'Employee Comments:', 'text', [2, 3, 4, 5, 6]],
...
questions.each do |question|
	if question[0] == "Section I"
		sec = Section.where(title: 'Section I').first
	elsif question[0] == 'Section II'
		sec = Section.where(title: 'Section II').first
	elsif question[0] == 'Section III'
		sec = Section.where(title: 'Section III').first
	elsif question[0] == 'Section IV'
		sec = Section.where(title: 'Section IV').first
	elsif question[0] == 'Section V'
		sec = Section.where(title: 'Section V').first
...
designer_questions.each do |question|
	if question[0] == "Section I"
		sec = Section.where(title: 'Section I').last
	elsif question[0] == 'Section II'
		sec = Section.where(title: 'Section II').last
	elsif question[0] == 'Section III'
		sec = Section.where(title: 'Section III').last
	elsif question[0] == 'Section IV'
		sec = Section.where(title: 'Section IV').last
	elsif question[0] == 'Section V'
		sec = Section.where(title: 'Section V').last
	elsif question[0] == 'Employee Section'
